...
class VectsetVAE(nn.Module):
    ...
    def from_pretrained(
        ...
        variant='fp16',
        subfolder='hunyuan3d-vae-v2-mini-withencoder',#'hunyuan3d-vae-v2-1', 
        **kwargs,
    ):
...
class ShapeVAE(VectsetVAE):
    ...
    def encode(self, surface, sample_posterior=True):
        ...
        # print("[INFO FROM ENCODER] WE are getting latent shape as")
        # print(latents.shape, self.pre_kl.weight.shape) #TODO remove  
